...
export const OrderModal: React.FC<OrderModalProps> = ({
  ...
  const { dir, getText } = useSiteContent();
  ...
  return (
    <div
      ...
      dir={dir}
    >
      <div className="glass-panel bg-[#1E4B57]/95 border border-[#EDEAE4]/20 rounded-[28px] max-w-lg w-full overflow-hidden shadow-2xl relative text-start">
          ...
          <div className="flex items-center gap-2.5 sm:gap-3 min-w-0">
            ...
            <div className="min-w-0">
              <h3 className="font-bold text-xs sm:text-base text-[#EDEAE4] font-vazir whitespace-nowrap">
                {getText('orderModal.title', 'درخواست همکاری و استعلام قیمت')}
              </h3>
            </div>
          </div>
          ...
          {success ? (
            ...
            >
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5">
                <div>
                  <label className="block text-xs font-bold text-[#EDEAE4]/80 mb-1.5 font-vazir">
                    {getText('orderModal.fullName', 'نام و نام خانوادگی')}{' '}
                  ...
                  <input
                    ...
                    className="w-full px-3.5 py-2.5 rounded-xl bg-[#EDEAE4]/[0.06] border border-[#EDEAE4]/15 text-sm text-[#EDEAE4] focus:outline-none focus:border-[#C9A24B] transition-colors font-vazir text-start"
                  />
                </div>

                <div>
                  <label className="block text-xs font-bold text-[#EDEAE4]/80 mb-1.5 font-vazir">
                    {getText('orderModal.phone', 'شماره همراه (واتساپ / تماس)')}{' '}
                    <span className="text-[#C9A24B]">*</span>
                  </label>
                  ...
                  <input
                    ...
                    className="w-full px-3.5 py-2.5 rounded-xl bg-[#EDEAE4]/[0.06] border border-[#EDEAE4]/15 text-sm text-[#EDEAE4] focus:outline-none focus:border-[#C9A24B] transition-colors font-latin text-start"
                    dir="ltr"
                  />
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5">
                <div>
                  <label className="block text-xs font-bold text-[#EDEAE4]/80 mb-1.5 font-vazir">
                    {getText('orderModal.company', 'نام فروشگاه / شرکت / شهر')}
                  </label>
                ...
                <div>
                  <label className="block text-xs font-bold text-[#EDEAE4]/80 mb-1.5 font-vazir">
                    {getText('orderModal.type', 'نوع درخواست')}
                  </label>
                  ...
                  <select
                    ...
                    className="w-full px-3.5 py-2.5 rounded-xl bg-[#1E4B57] border border-[#EDEAE4]/15 text-xs text-[#EDEAE4] focus:outline-none focus:border-[#C9A24B] font-vazir text-start"
                  >
                    <option value="سفارش عمده">
                      {getText('orderModal.inquiryBulk', 'سفارش عمده')}
                    </option>

                    <option value="دریافت کاتالوگ و لیست قیمت روز">
                      {getText('orderModal.inquiryCatalog', 'دریافت کاتالوگ و لیست قیمت روز')}
                    </option>

                    <option value="اخذ نمایندگی پخش استانی">
                      {getText('orderModal.inquiryAgency', 'اخذ نمایندگی پخش استانی')}
                    </option>

                    <option value="صادرات و بازرگانی خارجی">
                      {getText('orderModal.inquiryExport', 'صادرات و بازرگانی خارجی')}
                    </option>
                  </select>
                </div>
              </div>
              ...
              <div>
                <label className="block text-xs font-bold text-[#EDEAE4]/80 mb-1.5 font-vazir">
                  {getText('orderModal.notes', 'توضیحات و مدل‌های مدنظر')}
                </label>
                ...
                <textarea
                  ...
                  className="w-full px-3.5 py-2.5 rounded-xl bg-[#EDEAE4]/[0.06] border border-[#EDEAE4]/15 text-sm text-[#EDEAE4] focus:outline-none focus:border-[#C9A24B] transition-colors font-vazir text-start resize-none"
                />
              </div>
              ...
              <div className="pt-2">
                ...
                >
                  ...
                  <span>
                    {submitting
                      ? getText('orderModal.submitting', 'در حال ارسال اطلاعات...')
                      : getText('orderModal.submit', 'ارسال درخواست استعلام قیمت')}
                  </span>
                </button>
              </div>
            </form>
